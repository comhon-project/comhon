...
class RequestablePropertyException extends ComhonException {
	...
	public function __construct(Property $property, Model $model) {
		...
		$message = "cannot request {$isIdMessage}property '{$property->getName()}' on model '{$model->getName()}' in public context";
		parent::__construct($message, ConstantException::REQUESTABLE_PROPERTY_EXCEPTION);
	}
