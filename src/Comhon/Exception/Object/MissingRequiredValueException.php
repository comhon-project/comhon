...
class MissingRequiredValueException extends ComhonException {
	...
	public function __construct(UniqueObject $object, $propertyName, $unset = false) {
		$message = $unset
			? "impossible to unset required value '$propertyName' on loaded comhon object with model '{$object->getModel()->getName()}'"
			: "missing required value '$propertyName' on loaded comhon object with model '{$object->getModel()->getName()}'";
